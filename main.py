...
x1_values = np.linspace(-90, 90, 1000)
...
# Визначення області значень x
x2_values = np.linspace(-90, 90, 1000)
...
x3_values = np.linspace(0, 100, 1000)
...
temperature["not wery hot"] = fuzz.trimf(temperature.universe, [50, 60, 70])
...
tap_system.input["temperature"] = 96
